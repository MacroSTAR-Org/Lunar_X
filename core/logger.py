...
class EmojiFormatter(logging.Formatter):
    _log_level_colors: ClassVar[dict[int, str]] = {
    ...
    _log_level_emojis: ClassVar[dict[int, str]] = {
        logging.DEBUG: "🐛",
        logging.INFO: "ℹ️",
        logging.WARNING: "⚠️",
        logging.ERROR: "❌",
...
class LunarLogger:
    ...
    def _setup_logger(self, name: str, format_str: str, level: str):
        ...
        handler.setFormatter(EmojiFormatter(format_str, datefmt="%Y-%m-%d %H:%M:%S"))
    ...
    def set_file_save_levels(self, levels: list[str] | None):
        """设置写入文件的日志级别白名单。
