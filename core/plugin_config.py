...
def plugin_dir(plugins_root: str, name: str) -> str | None:
...
def validate_and_build(
    schema: list[dict[str, Any]], incoming: dict[str, Any], existing: dict[str, Any]
...
def flatten_for_form(schema: list[dict[str, Any]], config: dict[str, Any]) -> dict[str, Any]:
    ...
    return {item["key"]: get_nested(config, item["key"], item.get("default")) for item in schema}
